...
iptables
    ...
    chef.add_recipe "dqneo::chsh"
    chef.add_recipe "dqneo::packages"
    chef.add_recipe "dqneo::php55"
    chef.add_recipe "dqneo::sshkey"
    chef.add_recipe "dqneo::dotfiles"
    chef.add_recipe "dqneo::hellohtml"
    chef.add_recipe "dqneo::hellophp"
    chef.add_recipe "plenv"
    chef.add_recipe "plenv::cpanmodules"
    chef.add_recipe "imagemagick"
    chef.add_recipe "dqneo::myrepos"
    chef.add_recipe "dqneo::apacheconf"
